...
runners.run_single_molecule_optimization(oxygen_optimization.input_filename,oxygen_optimization.output_filename )
...
print(np.linalg.norm(optimized_oxygen.xyz[1]-optimized_oxygen.xyz[0]))


#creating an instance of the MD class, also defining the parametrs of our md simulation
box=mb.box.Box(lengths=[1,1,1])
q=MD(molecules=[optimized_oxygen],box=box,cutoff=600,functional='PBE',basis_set={'O':'DZVP-MOLOPT-GTH'},periodicity='XYZ',n_molecules=[20],traj_type='PDB',seed=1,project_name='twentyO2molecules')
