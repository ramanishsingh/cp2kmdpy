...
def single_molecule_opt_files(molecule,functional,box,cutoff,scf_tolerance,basis_set,basis_set_filename, potential_filename,fixed_list,periodicity,n_iter):
    ...
    mySim.FORCE_EVAL.DFT.SCF.MAX_SCF=1
...
def md_files(molecules,functional,box,cutoff,scf_tolerance, basis_set, basis_set_filename,potential_filename, fixed_list, periodicity,simulation_time,time_step,ensemble,project_name,temperature,pressure,n_molecules,thermostat,traj_type,traj_freq,seed):
